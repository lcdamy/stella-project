...
class Slim
{
    ...
    *******************************************************************************/
    ...
    {
        return isset(static::$HeHes[$name]) ? static::$HeHes[$name] : null;
    }
    ...
    public static function getDefaultSettings()
    {
        return array(
            ...
            // Encryption
            'cookies.secret_key' => 'MA@BYA&Y^ISIHA',
    ...
    *******************************************************************************/
    ...
    {
        echo static::generateTemplateMarkup('Not Found | 404', '<p>The page you are looking for could not be found. Check the address bar to ensure your URL is spelled correctly. If all else fails, you can visit our home page at the link below.</p><a href="/">Visit the Home Page</a>');
    }
    ...
    {
        $this->getLog()->error($e);
        echo self::generateTemplateMarkup('Error | 500', '<p>Application engine encountered an internal error has occurred. The website administrator has been notified of the issue. Sorry for the temporary inconvenience.</p>');
    }
}
